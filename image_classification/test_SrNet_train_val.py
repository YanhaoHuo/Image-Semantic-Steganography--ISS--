...
def train(train_data, valid_data):
    ...
    with open(f'./results/Sema_add2_SRnet{bpp}.csv', 'a', newline='', encoding='utf-8') as f:
        f.truncate(0)
    print(l * 100+num)
    for epoch in range(118, num_epochs):
        ...
        if (epoch + 1) % 1 == 0:
            ...
            torch.save(checkpoint, f'./model/SrNetA{bpp}{k1}{k2}_%s.pth' % (str(epoch)))
...
if __name__ == "__main__":
    ...
    #     f'./model/SrNetA{bpp}{k1}{k2}_%s.pth' % (str(117)))  # load breakpoint
